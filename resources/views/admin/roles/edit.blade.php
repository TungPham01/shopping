            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        @endif
                        <form method="post" action="{{ route('roles.update', $role->id) }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="col-12">
                                        ...
                                        <div class="row">
                                            @foreach($parent->permissionsChildren as $children)
                                                <div class="card-body col-3">
                                                    <h5 class="card-title">
                                                        <input id="{{ $children->name }}" type="checkbox" name="permission_id[]" {{ $permissionsChecked->contains('id', $children->id) ? 'checked' : ''}} value="{{ $children->id }}" class="checkbox_childer">
