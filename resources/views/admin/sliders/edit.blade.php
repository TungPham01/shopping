                    ...
                    <div class="col-8">
                        ...
                        <form method="post" action="{{ route('sliders.update',$slider->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Nhập tên sldier" name="name" value="{{ $slider->name }}">
                                {{--@error('name')--}}
                                {{--<div class="alert alert-danger">--}}
                                {{--{{ $message }}--}}
                                {{--</div>--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-2">
                                    <img style="height: 200px;width: 300px;object-fit: cover" src="{{ asset($slider->image_path) }}" alt="">
                                </div>
                            </div>
